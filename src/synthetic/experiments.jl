function synchronization_sensitivity(;methods=["spanning-tree", "spectral", "sphere", "dyadic", "least-squares-orthogonal", "gaia", "crossproduct", "euclidean", "weiszfeld" ],vary_parameter="noise", σ_fixed=0.0, num_trials=Int(1e3), parameter_min=0.0, parameter_range=0.1, parameter_max=1.0, error=angular_distance)
...
# E_noise = synchronization_sensitivity(methods=avg_methods, parameter_min=0.0, parameter_range=0.05, parameter_max=0.2, num_trials=100, error=angular_distance);
