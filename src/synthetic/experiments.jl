...
# E = synchronization_sensitivity(σ_range=0.05, σ_max=0.2, num_trials=1000, error=angular_distance);
...
# @load "synchronization_sensitivity_noise.jld2"  
# @load "synchronization_sensitivity_noise_zero_pointOne_point5.jld2"
